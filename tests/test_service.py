...
class ServiceTest(unittest.TestCase):
    ...
    def test_error_create_checks(self):
        ...
        key = [k for k in checks.keys() if isinstance(k, int)]
        self.checks.append(key)
        self.assertTrue('errors' in checks.keys())
    ...
    def test_error_create_objects(self):
        ...
        key = [k for k in objects.keys() if isinstance(k, int)]
        self.objects.append(key)
        self.assertTrue('errors' in objects.keys())
    ...
    def _get_test(self, params, data, api_func, test_func):
        ...
        result_keys = [key for key in all_groups.keys() if key in data.keys()]
        self.assertEqual(len(result_keys), len(data.keys()))
    ...
    def test_get_objects(self):
        ...
        result_keys = [key for key in ret.keys() if key in keys]
