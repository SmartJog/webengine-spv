...
class ServiceTest(unittest.TestCase):
    ...
    def test_get_status_group_name(self):
        ...
        ret = self.imp.call('spv.services', 'get_checks', {'group_name': [groups.values()[0]['name']]})
    ...
    def test_get_status_object_address(self):
        ...
        groups, objects, checks = self._get_status_tests_create_data()
        ret = self.imp.call('spv.services', 'get_checks', {'object_address': objects.values()[0]['address']})
        self._get_status_test_value(ret, groups, objects, checks)

    def test_get_status_plugin_name(self):
        """ ['get_checks'] Get every status with on specific plugin name """
        groups, objects, checks = self._get_status_tests_create_data()
        ret = self.imp.call('spv.services', 'get_checks', {'plugin_name': checks.values()[0]['plugin']})
        self._get_status_test_value(ret, groups, objects, checks)

    def test_get_status_plugin_check(self):
        """ ['get_checks'] Get every status with on specific plugin check """
        groups, objects, checks = self._get_status_tests_create_data()
        ret = self.imp.call('spv.services', 'get_checks', {'plugin_check': checks.values()[0]['plugin_check']})
        self._get_status_test_value(ret, groups, objects, checks)
    ...
    def test_get_status_check_id(self):
        ...
        ret = self.imp.call('spv.services', 'get_checks', {'check_id': checks.keys()[0]})
        self._get_status_test_value(ret, groups, objects, checks)
    ...
    def test_get_status_status_id(self):
        ...
        ret = self.imp.call('spv.services', 'get_checks', {'group_id': groups.keys()[0], 'get_status_infos': True})
        self.assertEqual(ret['status'][0]['status_infos'].keys(), ['key_status'])
    ...
    def test_get_status_limit(self):
        ...
        checks_second = self.imp.call('spv.services', 'create_checks',
                [{'plugin': '1', 'plugin_check': '2', 'name': '3', 'repeat': 100,
                    'repeat_on_error': 100 , 'group_id': groups.keys()[0]}])
        self.checks.append(checks_second.keys())
        ret = self.imp.call('spv.services', 'get_checks', {'group_id': groups.keys()[0], 'limit': 1})
    ...
    def test_get_status_object_info(self):
        ...
        groups, objects, checks =  self._get_status_tests_create_data()
        ret = self.imp.call('spv.services', 'get_checks', {'group_id': groups.keys()[0], 'get_object_infos': True})
    ...
    def test_get_status_check_info(self):
        ...
        groups, objects, checks =  self._get_status_tests_create_data()
        ret = self.imp.call('spv.services', 'get_checks', {'group_id': groups.keys()[0], 'get_check_infos': True})
    ...
    def test_create_status(self):
        ...
        gets = {}
        gets[0] = self.imp.call('spv.services', 'get_checks', {'group_id': groups.keys()[0]})
        gets[1] = self.imp.call('spv.services', 'get_checks', {'check_id': checks.keys()[0]})
        gets[2] = self.imp.call('spv.services', 'get_checks', {'object_address': objects.values()[0]['address']})
